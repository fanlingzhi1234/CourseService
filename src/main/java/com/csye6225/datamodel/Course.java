...
public class Course {
    ...
    public Course(String id, String courseId, String name, String boardId, String department, List<String> roster, String professorId, String taId, String notificationTopic) {
        Id = id;
